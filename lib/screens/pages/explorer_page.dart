...
class _ExplorerPageState extends State<ExplorerPage> {
  ...
  List<Hotel> get _filteredHotels {
    if (_selectedVibe == 0) return _hotels;
    final vibe = _vibes[_selectedVibe];
    final results =
        _hotels.where((hotel) => _matchesVibe(hotel, vibe)).toList();
    return results.isEmpty ? _hotels : results;
  }
  ...
  Future<void> _loadHotels() async {
    final list = await _hotelService.getFeaturedEstablishments();
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Les offres ne sont pas encore disponibles. Veuillez patienter pendant que nous récupérons les hôtels depuis le backend.',
              style: GoogleFonts.montserrat(
                ...
                children: [
                  Image.network(
                    ...
                    errorBuilder: (_, __, ___) => Container(
                      ...
                      child: const Center(
                        child:
                            Icon(Icons.hotel, size: 60, color: Colors.white38),
                      ),
                    ),
                  ),
                  Positioned(
                  ...
                  Row(
                    children: [
                      const Icon(Icons.location_on,
                          color: AppColors.grayText, size: 13),
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('DriFt Experiences VIP',
                style: GoogleFonts.montserrat(
                    color: Colors.black87,
                    fontSize: 18,
                    fontWeight: FontWeight.w900)),
            const SizedBox(height: 8),
            Text('Aucune expérience VIP disponible actuellement',
                style: GoogleFonts.montserrat(
